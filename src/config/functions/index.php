...
class MP3Analizador{
    ...
    public function __construct($filename){
        $this->archivo = __DIR__."/../../../public/tmp/".$filename;
        $this->powarr  = array(0=>1,1=>2,2=>4,3=>8,4=>16,5=>32,6=>64,7=>128);
        $this->blockmax= 1024;
        
        $this->mp3data = array();
        $this->mp3data['Filesize'] = filesize($this->archivo);

        // $this->fd = fopen($this->archivo, 'a+');
        // $this->prefetchblock();
        // $this->readmp3frame();
    }
    ...
    public function get_metadata(){
        // return array("archivo" => $this->archivo, "existe" => file_exists($this->archivo));
        return $this->mp3data;
    }
