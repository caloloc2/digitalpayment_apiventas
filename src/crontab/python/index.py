...
cursor = db.cursor()
query = "SELECT N.id_lista, N.documento, N.nombres, N.ciudad, N.telefono, N.correo, N.ruc, N.cedula, N.razonSocial, N.actividadContribuyente, N.fechaInicioActividades, E.nombreComercial, E.direccionCompleta FROM notas_registros N LEFT JOIN notas_registros_establecimientos E ON N.id_lista = E.id_lista WHERE ((N.id_lista=219496) OR (N.id_lista=221637) OR (N.id_lista=221711) OR (N.id_lista=221786) OR (N.id_lista=221810)) ORDER BY N.id_lista LIMIT 1"
