                                        ...
                                        if (count($listado) > 0){
                                            ...
                                            foreach ($listado as $linea) {
                                                ...
                                                if (!empty($documento)){
                                                    ...
                                                    $consulta = $mysql->Consulta_Unico("SELECT * FROM notas_registros WHERE ((documento LIKE '%".$documento."%')) AND (banco=".$banco.")");
                    ...
                    if (is_array($redes)){
                        if (count($redes) > 0){
                            foreach ($redes as $linea) {
                                ...
                                $consultaResp = $mysql->Consulta_Unico("SELECT
                                ...
                                WHERE ".$porZona." ".$porCiudad." AND (P.idRed=".$linea['id'].") AND (P.idRespuesta=1)
                                ...
                                LEFT JOIN personasestablecimientos E
                                ON P.idRegistro = E.id
                                WHERE ".$porZona." ".$porCiudad." AND (P.idRed=".$linea['id'].") AND (P.idRespuesta=2)
                                GROUP BY P.idRed, P.idRespuesta
                                ORDER BY P.idRed ASC, P.idRespuesta ASC"); 
